...
import spell.lib.adapter.data

DataContainer = spell.lib.adapter.data.DataContainer
Var           = spell.lib.adapter.data.Var
...
###############################################################################
#: Limit app crit selection constants
ALL = 'ALL'
...
DATETIME = 'datetime'
ABSTIME  = DATETIME
#: Value type time. Used with ValueType modifier.
RELTIME  = 'reltime'
