...
Expected = 'Expected'
#: Accepts a comma separated list of nominal status codes
Nominal = 'Nominal'
#: Accepts a comma separated list of error status codes
Error = 'Error'
#: Accepts a comma separated list of ignore status codes
Ignore = 'Ignore'
#: Accepts a comma separated list of warning status codes
Warning = 'Warning'
#: Identifies a valid range of values
#:
